...
<nav class="bg-white border-b border-gray-200">
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
        <!-- Logo -->
        <a href="<?php echo home_url(); ?>" class="text-2xl font-bold text-black">Daily News</a>

        <!-- Botão do menu mobile -->
        <button id="menu-toggle" class="md:hidden text-black focus:outline-none" aria-label="Abrir menu">
